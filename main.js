// elm-watch hot {"version":"2.0.0-beta.3","targetName":"dev","webSocketConnection":3000}
"use strict";
(() => {
...
var $author$project$Types$CuentaContrato = {$: 'CuentaContrato'};
...
var $author$project$Types$InformacionCorteLuz = F5(
	function (alimentador, cuentaContrato, cuenta, direccion, horarios) {
		return {alimentador: alimentador, cuenta: cuenta, cuentaContrato: cuentaContrato, direccion: direccion, horarios: horarios};
	});
var $author$project$Types$HorarioCorte = F3(
	function (fechaCorte, horaDesde, horaHasta) {
		return {fechaCorte: fechaCorte, horaDesde: horaDesde, horaHasta: horaHasta};
	});
...
var $author$project$Api$getHorariosCortes = F2(
	function (documento, criterio) {
		...
		return $elm$http$Http$get(
			{
				expect: A2($elm$http$Http$expectJson, $author$project$Msg$GotApiResponse, $author$project$Json$decodeApiResponse),
				url: url
			});
	});
		...
		switch (msg.$) {
			...
			case 'ToggleLight':
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'Submit':
				return $elm$core$String$isEmpty(model.documento) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							errorDocumento: $elm$core$Maybe$Just('Debe ingresar el número de documento')
						}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					model,
					A2($author$project$Api$getHorariosCortes, model.documento, model.criterio));
			default:
				if (msg.a.$ === 'Ok') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									...
									errorServidor: $elm$core$Maybe$Just(errorResponse.message)
								}),
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								errorDocumento: $elm$core$Maybe$Nothing,
								errorServidor: $elm$core$Maybe$Just(
...
var $author$project$Msg$ToggleLight = {$: 'ToggleLight'};
...
var $author$project$Msg$UpdateCriterio = function (a) {
	return {$: 'UpdateCriterio', a: a};
};
var $author$project$Msg$UpdateDocumento = function (a) {
	return {$: 'UpdateDocumento', a: a};
};
...
var $author$project$Types$parseCriterio = function (s) {
	switch (s) {
		case 'CUENTA_CONTRATO':
			return $author$project$Types$CuentaContrato;
		case 'CUEN':
			return $author$project$Types$Cuen;
		case 'IDENTIFICACION':
			return $author$project$Types$Identificacion;
		default:
			return $author$project$Types$CuentaContrato;
	}
};
					...
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2(
								'invalid',
								$author$project$Util$isJust(model.errorDocumento))
							]))
					]),
				_List_fromArray(
					[
						...
						$author$project$Main$viewErrorDocumento(model.errorDocumento),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$value(
								$author$project$Types$getCriterioValue(model.criterio)),
								$elm$html$Html$Events$onInput(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$value(
										$author$project$Types$getCriterioValue($author$project$Types$CuentaContrato))
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										$author$project$Types$displayCriterio($author$project$Types$CuentaContrato))
									])),
								A2(
								$elm$html$Html$option,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$value(
										$author$project$Types$getCriterioValue($author$project$Types$Cuen))
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										$author$project$Types$displayCriterio($author$project$Types$Cuen))
									])),
								A2(
								$elm$html$Html$option,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$value(
										$author$project$Types$getCriterioValue($author$project$Types$Identificacion))
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										$author$project$Types$displayCriterio($author$project$Types$Identificacion))
									]))
							])),
						A2(
						$elm$html$Html$label,
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text(horario.fechaCorte)
												])),
											A2(
											$elm$html$Html$div,
											_List_fromArray(
											...
											_List_fromArray(
												[
													$elm$html$Html$text(horario.horaDesde)
												])),
											A2(
											$elm$html$Html$div,
											_List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(info.alimentador)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(info.cuenta)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(info.cuentaContrato)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(info.direccion)
							]))
					]))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Main$viewLightBulb(model.lightsOn)
							])),
						A2(
						$elm$html$Html$h5,
						_List_fromArray(
						...
						$elm$core$Maybe$withDefault,
						$elm$html$Html$text(''),
						A2($elm$core$Maybe$map, $author$project$Main$viewInformacionCuenta, model.informacionCortes)),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						A2(
							$elm$core$Maybe$map,
							function (info) {
								return $author$project$Main$viewHorariosCortes(info.horarios);
							},
							model.informacionCortes))
					])),
				$author$project$Main$viewErrorServidor(model.errorServidor)
			]));
};
